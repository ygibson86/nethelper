...
- Подключение из карточки устройства или по вручную введённому IPv4-адресу.
...
- Дополнительная совместимость со старыми Eltex для устройств, отмеченных производителем Eltex.
